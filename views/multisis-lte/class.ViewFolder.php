        ...
        <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              ...
              <p>Ver y gestionar eventos</p>
            </div>
            <div class="icon">
              <i class="fa fa-file-text-o"></i>
            </div>
            <a href="/out/out.GestionarEventos.php" class="small-box-footer">Acceder<i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              ...
              <p>Ver y gestionar base de datos de personas</p>
            </div>
            <div class="icon">
              <i class="ion ion-person-add"></i>
            </div>
            <a href="/out/out.GestionarPersonas.php" class="small-box-footer">Acceder<i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-4 col-xs-6">
      ...
      <div class="row">
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              ...
              <li class="pull-left header"><i class="fa fa-inbox"></i> Resumen de invitados y confirmados</li>
            </ul>

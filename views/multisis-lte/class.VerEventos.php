 ...
 **/
	...
	{ /* {{{ */
		...
		$this->htmlStartPage(getMLText("lista_eventos"), "skin-blue sidebar-mini  sidebar-collapse");
		$this->containerStart();
		$this->mainHeader();
		$this->mainSideBar();
 ...
 $this->startBoxPrimary("Listado de eventos realizados por ENAFOP");
 ...
 <div class="box">
            <div class="box-header">
              <div class="alert alert-success alert-dismissible">
                ...
                <h4><i class="icon fa fa-info"></i> En esta pantalla puede ver y editar datos de los eventos</h4>
               Así como ver cuantas personas han sido invitadas y cuántas han confirmado.
                <br>
                Haga clic en el nombre del evento para editar sus datos.
              </div>
            </div>
            <!-- /.box-header -->
            <div class="box-body no-padding">
              <table id="tablaEventos" class="table table-hover table-striped table-condensed">
               ...
               <tbody>
                	...
                	{
                		echo ' <tr>';
                		//1. nombre y enlace para editar
                    $idEvento=$res1[$cont]['id'];
        echo "<td><a href=\"/out/out.EditarEvento.php?id=".$idEvento."\">".$res1[$cont]['nombre']."</a></td>";
                		 //2. fecha de inicio a fin
                		 $inicio=convertirFecha($res1[$cont]['fecha_inicio']);
                		 $fin=convertirFecha($res1[$cont]['fecha_fin']);
                		  echo "<td>".$inicio." hasta el ". $fin."</td>";
                		  // 3. lugar
                		  echo "<td>".$res1[$cont]['lugar']."</td>";               		
                		  //4. enlace para ver confirmaciones
                		   echo "<td><a href=\"/out/out.verEstado.php?id=".$idEvento."\">Ver estado del evento</a></td>";
                		   echo '</tr>';
